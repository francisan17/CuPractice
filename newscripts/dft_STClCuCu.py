...
#CuCu bridge
#slab = Bridge_STCl_CuCu (bulk, n_layers=n_layers, vacuum=10, Cl_Z_position=9.5)
#write('Bridge_STCl_CuCu.xyz', slab)
#print(f'{slab=}')
#slab.calc = socket_calc
#E_slab = slab.get_potential_energy()
#print(f'{n_layers=} {E_slab=}')

newtraj=read('Bridge_STCl_CuCU7.traj')
qn = LBFGS(newtraj, trajectory=f'Bridge_STCl_CuCu_new{n_layers}.traj')
qn.run(fmax=0.01)
