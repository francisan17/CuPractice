...
from cu2o_bulk_colab import cu2o_bulk, cu2o111, Bridge_STCl_CuO, atop_unsatCu_STCl, atop_satCu_STCl, Bridge_STCl_CuCu, ST4x4 
...
#Bridge CuO  
slab= ST4x4(bulk,n_layers=7,vacuum=10)
write('ST4x4.xyz', slab)
print(f'{slab=}')
slab.calc = socket_calc
E_slab = slab.get_potential_energy()
print(f'{n_layers=} {E_slab=}')

qn = LBFGS(slab, trajectory=f'ST4x4{n_layers}.traj')
qn.run(fmax=0.01)
