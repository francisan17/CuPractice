...
from cu2o_bulk_colab import cu2o_bulk, cu2o111, CuDO_FCC111
...
for n_layers in range(3,11):
  vacuum=10
  superslab = CuDO_FCC111(bulk, n_layers, vacuum)
  ...
  qn = LBFGS(superslab, trajectory=f'CuD_Os_{n_layers}.traj')
  qn.run(fmax=0.01 )
  E_slab = superslab.get_potential_energy()
